...
Reproduction and falsification are straightforward: run \texttt{framework/organismo\_final.py} and modify the world (move the fog, place food inside it, freeze $\Phi$, shuffle the actions). A minimal system of this size is meant to be inspected and broken, and that is the point. The code and logs that accompany this preprint will be released publicly on GitHub and archived with a Zenodo DOI at the time of publication.
